...
class TransportationsDataTable extends DataTable
{
    ...
    public function dataTable()
    {
        ...
        ]))->get('https://ashaxisdmc.odoo.com/api/tariff/get_transportation');
        ...
        return (new CollectionDataTable($data))
            ...
            ->editColumn('partner_name', function ($transportation) {
                return '<a href="' . route('contract.transportations.show', Arr::get($transportation, 'id')) . '">' . Arr::get($transportation, 'partner_id.name') . '</a>';
            })
            ...
            ->addColumn('action', function ($transportation) {
                return view('pages.apps.contract.transportations.columns._actions', compact('transportation'));
            })
            ->addIndexColumn();
    }
