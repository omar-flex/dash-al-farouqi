...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('role', content: function (User $model) {
                $class = app(\App\Actions\GetThemeType::class)->handle('bg-light-? text-?', $model->roles->first()?->name);
                return sprintf('<div class="badge ' . $class . ' fw-bold">%s</div>', $model->roles->first()?->name);
            })
