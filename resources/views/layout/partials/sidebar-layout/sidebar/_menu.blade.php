...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
            ...
            {{--<div class="menu-item">
                <a class="menu-link {{ request()->routeIs('contract.hotels') ? 'active' : '' }} "
                   href="{{route('contract.hotels')}}">
                    <span class="menu-icon">
                        <i class="fa-solid fa-hotel"></i>
                    </span>
                    <span class="menu-title"> Hotels </span>
                </a>
                <a class="menu-link {{ request()->routeIs('contract.transportations') ? 'active' : '' }} "
                   href="{{route('contract.transportations')}}">
                    <span class="menu-icon"><i class="fa-solid fa-road"></i></span>
                    <span class="menu-title"> Transportations </span>
                </a>
                <a class="menu-link {{ request()->routeIs('contract.restaurants') ? 'active' : '' }}" href="{{route('contract.restaurants')}}">
                    <span class="menu-icon">
                        <i class="fa-solid fa-utensils"></i>
                    </span>
                    <span class="menu-title"> Restaurants </span>
                </a>
                <a class="menu-link {{ request()->routeIs('contract.guides') ? 'active' : '' }}" href="{{route('contract.guides')}}">
                    <span class="menu-icon">
