            ...
            <form action="{{ route('operation-management.outbounds.store') }}" method="POST"
                ...
                <div class="row">
                    ...
                    @isset($outbound)
                        ...
                        <div class="col-md-3 mb-7">
                            <label class="fw-semibold fs-6 mb-2"> Warehouse </label>
                            <div class="input-group mb-5">
                                <input type="text" class="form-control form-control-solid-bg"
                                       value="{{ $outbound->EnterRequest?->Warehouse?->code }}"
                                       disabled>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-7">
                        ...
                        <textarea class="form-control form-control-solid-bg mb-2" name="general_description_goods" style="min-height: 30px" placeholder="General description Goods">@isset($outbound){{ $outbound->general_description_goods }}@endisset</textarea>
                    </div>
                    <div class="col-md-6 mb-7">
